...
SET FILENAME=%FOLDER%\MMbase_%YEAR%%MONTH%%DAY%_%HOUR%%MINUTE%.dt
...
%PROG% DESIGNER /IBName %BASENAME% /N %USER% /P %PWD% /DumpIB %FILENAME% /UC %ALLOWCODE% /DisableStartupMessages
